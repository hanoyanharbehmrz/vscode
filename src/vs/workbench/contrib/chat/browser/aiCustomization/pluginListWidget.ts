...
export class PluginListWidget extends Disposable {
	...
	private updateAccessState(): void {
		...
		if (disabled) {
			...
			if (policyLocked) {
				this.disabledMessage.textContent = localize('pluginsDisabledByPolicy', "Plugin integration in chat is disabled by your organization. Contact your administrator if you need to install or use plugins.");
			} else {
